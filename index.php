<?php
//header("Location: indexcomingsoon.php");
        ...
        <div class="container main">
            <div class="row home">
                ...
                <div id="index_right" class="col-md-6 text-center right">
                    <div class="logo">
                        <img src="assets/img/projeccelator.jpeg" height="90" width="90">
                        <h4>Projeccelator</h4>
                    </div>
                    <p class="home-description">
                        <b>Welcome to Projeccelator.</b><br>Win a chance to get funded</p>
                    ...
                    <div class="social">
                        <a href="https://www.facebook.com/Radssoon/"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                        <a href="https://twitter.com/radssoon"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                     </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <p>Made with <i class="fa fa-heartbeat" aria-hidden="true"></i> by <a href="http://www.radssoon.com/">Radssoon</a></p>
                         <p>contact: &nbsp;&nbsp;radssoon@gmail.com&nbsp;<br></p>
                         <p></p>
                         <p></p>
                    </div>
                </div>
    ...
    font-family: "Crimson";">Inorder to validate students performance , judges can login with their ID's.
                            ...
                            <div style="align=right">
                                <div class="LoginFT mds-3">
                                    <img id="Avimg" class="Avatar mds-2" src="assets/img/projeccelator.jpeg" />
                                    <div class="Content">
                        ...
                        <div class="LoginFT mds-3">
                            ...
                            <div class="Content">
                                <form action="index.php" method="post" >
                                    ...
                                    <div class="FP">
                                        <a id="fp-btn" class="btn-fp" href="#popup3">Forgot password?</a>
                                    </div>
                                    <div>
...
<div id="popup3" class="overlay">
                ...
                <div class="popup">
                  <h2>Enter the email_id</h2>
                    <a class="close" href="#">&times;</a>
                    <div class="content">                 
                        <div class="Content" style="padding:2px 2px 2px 2px">
                                <form  action="index.php" method = "post">
                                <input class="Textbox" name="mail" type="search" placeholder="Mail iD" required/>
                                    <br>
                                    <div>
                                    <button class="btn btn-log btn-normal" name="email" type ="post" >Forget Password?</button>
                                    </div>
                                </form>
                            </div>
                    </div>
    ...
    <div id="hod_scroll" class="pages">
        ...
        <div class="container main">
            <div class="row">
                ...
                <br>
                    <img class="img-responsive img-rabbit" src="img/contact1.png" height="100" width="500">
                </div>
