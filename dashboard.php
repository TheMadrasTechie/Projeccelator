...
<div class="home-page">
 ...
 <a href="logout.php" class="button">Logout</a>
	...
	<div class="intro-content">
			...
			<img src="assets\img\aaaa.png" height="500" width="500" alt="" class="img-responsive center-block"><br><br><br>

		<!--<img src="assets\img\sample.png" alt="" class="img-responsive center-block logo">-->
			<div class="social-media">
				<a href="https://www.facebook.com/radssoon" class="fa fa-facebook" data-toggle="tooltip" title="Facebook"></a>
				<a href="https://twitter.com/radssoon" class="fa fa-twitter" data-toggle="tooltip" title="Twitter"></a>
	...
	<div class="four_nav_item menu">
		<div class="menu_button profile-btn" data-url_target="about_us">
			...
			<div class="heading"><i class="hidden-xs ion-ios-people-outline"></i>
				<h2 style=" font-weight: 900; "><?php if($_SESSION["user"]=="HOD"){echo "View Project Reports";}else{echo "About Us";} ?></h2>
			</div>
		</div>
		<div class="menu_button service-btn" data-url_target="aa">
			...
			<div class="heading"><i class="hidden-xs ion-ios-lightbulb-outline"></i>
				<h2 style=" font-weight: 900; "><?php if($_SESSION["user"]=="HOD"){echo "Declare Project Sessions";}elseif($_SESSION["user"]=="Faculty"){echo "Judge Projects";}elseif($_SESSION["user"]=="Student"){echo "Post Project";} ?></h2>
			</div>
		</div>
		<div class="menu_button portfolio-btn" data-url_target="portfolio">
			...
			<div class="heading"><i class="hidden-xs ion-ios-briefcase-outline"></i>
				<h2 style=" font-weight: 900; ">View Projects</h2>
			</div>
		</div>
		...
		<div class="menu_button contact-btn" data-url_target="contact">
			...
			<div class="heading"><i class="hidden-xs ion-ios-email-outline"></i>
				<h2 style=" font-weight: 900; ">Contact</h2>
			</div>
		</div>
	</div>
</div>
      ...
      <div class="clearfix footer">
        <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1">
          <div class="row">
             ...
             <p style="color:white">contact us&nbsp;:&nbsp;radssoon@gmail.com </p>
					   ...
					   if($_SESSION["user"] =="HOD")
{
  ...
  <div class=\"row\">
    <div class=\"col-half\">
	<h2 class=\"small-heading\">Declare Projects</h2>
        <h4>Date of the Exam:</h4>
        <div class=\"input-group\">
          <div class=\"col-third\">
             <input class=\"Textbox\" name=\"dd\" type=\"number\" min=\"1\" max=\"31\" placeholder=\"DD\" required/>
          </div>
          <div class=\"col-third\">
             <input class=\"Textbox\" name=\"mm\" type=\"number\" placeholder=\"MM\" min=\"1\" max=\"12\" required/>
          </div>
          <div class=\"col-third\">
             <input class=\"Textbox\" name=\"yy\" type=\"number\" placeholder=\"YYYY\" min=\"2017\" max=\"2020\" required/>
          </div>
        </div>
      </div>
  ...
  <option value=\"School of Management Studies\">School of Management Studies</option>
    ...
    <div class=\"row\">
      ...
      <div  >
         <input class=\"Textbox\" name=\"n_of_studs\" type=\"number\" placeholder=\"number\" min=\"1\" max=\"60\" required/>
        <div class=\"input-icon\"></div>
      </div>
...
<form action=\"dashboard.php\" method = \"POST\">
    ...
    <div class=\"row\">
      <h4>Project Name</h4>
         ...
         <input class=\"Textbox\" name=\"prj_name\" type=\"text\" placeholder=\"Name of the Project\"/ required>
    ...
    <h4>Short Description</h4>
      ...
      <h4>Applications</h4>
        ...
        <h4>Roll No of Students</h4>
           <h5>Student 1:</h5>
          <div class=\"col-third\">
             <input class=\"Textbox\" name=\"rl_no_1\" type=\"text\" placeholder=\"Roll no\"/ required>
          </div>
          </div>
...
<div class=\"row\">
     <h4>Faculty Incharge</h4>
         ...
         <input class=\"Textbox\" name=\"fcl_inc\" type=\"text\" placeholder=\"Enter the name of the Faculty\"/required>
    ...
    <h4>Technology Used</h4>
        ...
        <h4>IPR significant words</h4>
         ...
         <input class=\"Textbox\" name=\"ipr\" type=\"text\" placeholder=\"What can be used for IPR searching\"/required>
    ...
    <h4>Uniqueness</h4>
         ...
         <input class=\"Textbox\" name=\"uniq\" type=\"text\" placeholder=\"Unique features\"/required>
...
<div class=\"row\">
    <h4>Looking for</h4>
         ...
         <input class=\"Textbox\" name=\"lk_fr\" type=\"text\" placeholder=\"(eg:-funding,mentoring,guidance..)\"/required>
...
<div class=\"row\">
    <h4>Future Works</h4>
         ...
         <input class=\"Textbox\" name=\"ftr_wrks\" type=\"text\" placeholder=\"write about your future works\"/required>
...
<h4>Initial Funding</h4>
         ...
         <input class=\"Textbox\" name=\"int_fnd\" type=\"text\" placeholder=\"Amount spent on the project\"/required>
...
<h4>Total Funding</h4>
         ...
         <input class=\"Textbox\" name=\"tot_fnd\" type=\"text\" placeholder=\"Total Amount required to complete the project\"/required>
...
<h4>Contact Phone Number</h4>
         ...
         <input class=\"Textbox\" name=\"ttl_fnd\" type=\"number\" placeholder=\"Phone number of one student\" required pattern=\"[0-9]{10}\"/ required>
						...
						<div class=\"col-md-4 col-sm-12\">
							<div class=\"faq-desc-item\">
								<div class=\"text-center flip-container\">
									...
									<div class=\"flipper back\">
								  		<h5>$row[1]</h5>
										<p><b>Developed by:</b><br>$row[4] $row[5]<br>$row[6]  $row[7]<br>$row[8] $row[9]<br><b>Faculty:</b><br>$row[10]</p> <button class=\"btn btn-log btn-normal\" name=\"submit\" type =\"submit\" value=\"logjudge\" formtarget=\"_blank\">View</button></div>
			...
			<div class="clearfix full-height">
				...
				<div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1">
					<div class="contact-info">
						<div class="row">
							<div class="col-md-6">
								<div class="data"><i class="fa fa-map-marker"></i>  <span>RADSSOON<br>  BIT-TBI<br></span>
								</div>
								<div class="data"><i class="fa fa-envelope"></i>  <span>radssoon@gmail.com</span>
								</div>
								<!-- <div class="data"><i class="fa fa-phone"></i>  <span></span>
								</div> -->
							</div>
